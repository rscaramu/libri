...
// Listato 37.1 — Il nucleo del sensore. `connettiVeloce()` è il listato 30.3; `mqttConnetti()` il 26.1 senza il ciclo di riconnessione. Un ciclo completo con trasmissione dura circa 900 ms.
