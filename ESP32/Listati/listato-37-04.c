...
// Listato 37.4 — La struttura di un dispositivo `esp-matter`: un nodo, due endpoint, una callback per gli attributi che il controller scrive. La rete Thread e il commissioning sono gestiti dal framework.
